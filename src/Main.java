//Игрок ходит всегда первым
//Бот выбирает случайную клетку
//без ООП
//Индексация ходов начинается с 0
...
public class Main {
    ...
    private static String GAME_STATE_X_WON = "Игрок победил";
    private static String GAME_STATE_O_WON = "Бот победил";
    ...
    public static int[] inputCellCoordinates(String[][] board) {
        System.out.println("Введите 2 числа (ряд и колонку) через пробел от 0 до 2");
        ...
        do {
            ...
            if ((row < 0) || (row >= ROW_COUNT) || (col < 0) || (col >= COL_COUNT)) {
                System.out.println("Некорректное значение! Введите 2 числа от 0 до 2:");
    ...
    //X = 1, O = -1, empty = 0
    //используется для подсчета победителя
